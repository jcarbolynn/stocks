...
var ObjectUtils = function() {
  ...
  return _createClass(ObjectUtils2, null, [{
    ...
    key: "combinedRefs",
    value: function combinedRefs(innerRef, forwardRef12) {
      if (innerRef && forwardRef12) {
        if (typeof forwardRef12 === "function") {
          forwardRef12(innerRef.current);
        } else {
          forwardRef12.current = innerRef.current;
        }
      }
    }
  }, {
...
var TimesIcon = React7.memo(React7.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  ...
  _proto.handleExited = function handleExited(child, node) {
    ...
    if (this.mounted) {
      this.setState(function(state2) {
        var children2 = _extends7({}, state2.children);
...
function _toPrimitive6(input2, hint) {
  if (_typeof6(input2) !== "object" || input2 === null) return input2;
  var prim = input2[Symbol.toPrimitive];
  if (prim !== void 0) {
    var res = prim.call(input2, hint || "default");
...
var VirtualScroller = React18.memo(React18.forwardRef(function(inProps, ref) {
  ...
  var _React$useState5 = React18.useState(0), _React$useState6 = _slicedToArray5(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  ...
  var _React$useState9 = React18.useState(props.numToleratedItems), _React$useState10 = _slicedToArray5(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = React18.useState(props.loading || false), _React$useState12 = _slicedToArray5(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = React18.useState([]), _React$useState14 = _slicedToArray5(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
  ...
  var createLoader = function createLoader2() {
    ...
    var icon = props.loadingIcon || React18.createElement(SpinnerIcon, _extends9({}, loadingIconProps, {
      spin: true
    }));
...
function _toPrimitive7(input2, hint) {
  if (_typeof7(input2) !== "object" || input2 === null) return input2;
  var prim = input2[Symbol.toPrimitive];
  if (prim !== void 0) {
    var res = prim.call(input2, hint || "default");
...
var Ripple = React19.memo(React19.forwardRef(function(inProps, ref) {
  var _React$useState = React19.useState(false), _React$useState2 = _slicedToArray6(_React$useState, 2), isMounted = _React$useState2[0], setMounted = _React$useState2[1];
  ...
  return React19.createElement("span", _extends10({
    role: "presentation",
    ref: inkRef
  }, rootProps, {
    onAnimationEnd
...
function _toPrimitive8(input2, hint) {
  if (_typeof8(input2) !== "object" || input2 === null) return input2;
  var prim = input2[Symbol.toPrimitive];
  if (prim !== void 0) {
    var res = prim.call(input2, hint || "default");
...
var classes3 = {
  root: function root2(_ref) {
    ...
    return classNames("p-dropdown p-component p-inputwrapper", {
      ...
      "p-inputwrapper-filled": props.value !== void 0,
...
var BlankIcon = React21.memo(React21.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
  return React21.createElement("svg", _extends12({
    ...
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, pti), React21.createElement("rect", {
    width: "1",
    height: "1",
    fill: "currentColor",
    fillOpacity: "0"
...
var DropdownItem = React21.memo(function(props) {
  var mergeProps2 = useMergeProps();
  ...
  var iconRenderer = function iconRenderer2() {
    if (selected) {
      ...
      return React21.createElement(CheckIcon, checkIconProps);
    }
    var blankIconProps = mergeProps2({
      className: cx("blankIcon")
    }, getPTOptions("blankIcon"));
    return React21.createElement(BlankIcon, blankIconProps);
  };
  return React21.createElement("li", _extends12({
    key: props.label
  }, itemProps), checkmark && iconRenderer(), React21.createElement("span", itemGroupLabelProps, content), React21.createElement(Ripple, null));
});
...
var DropdownPanel = React21.memo(React21.forwardRef(function(props, ref) {
  var mergeProps2 = useMergeProps();
  ...
  var createFooter = function createFooter2() {
    if (props.panelFooterTemplate) {
      ...
      return React21.createElement("div", footerProps, content);
    }
    return null;
  };
  ...
  var createEmptyMessage = function createEmptyMessage2(emptyMessage, isFilter) {
    ...
    return React21.createElement("li", emptyMessageProps, message);
  };
  var createItem = function createItem2(option, index) {
    ...
    if (option.group && props.optionGroupLabel) {
      ...
      return React21.createElement("li", _extends12({
        key
      }, itemGroupProps), React21.createElement("span", itemGroupLabelProps, groupContent));
    }
    var optionKey = props.getOptionRenderKey(option) + "_" + index;
    var optionLabel = props.getOptionLabel(option);
    var disabled = props.isOptionDisabled(option);
    return React21.createElement(DropdownItem, {
      key: optionKey,
      label: optionLabel,
      index,
  ...
  var createFilterClearIcon = function createFilterClearIcon2() {
    if (props.showFilterClear && props.filterValue) {
      ...
      var icon = props.filterClearIcon || React21.createElement(TimesIcon, clearIconProps);
  ...
  var createFilter = function createFilter2() {
    if (props.filter) {
      ...
      var icon = props.filterIcon || React21.createElement(SearchIcon, filterIconProps);
      ...
      var content = React21.createElement("div", filterContainerProps, React21.createElement("input", filterInputProps), clearIcon, filterIcon);
      ...
      return React21.createElement("div", headerProps, content);
    }
    return null;
  };
  var createContent = function createContent2() {
    if (props.virtualScrollerOptions) {
      var virtualScrollerProps = _objectSpread$1(_objectSpread$1({}, props.virtualScrollerOptions), {
        ...
        contentTemplate: function contentTemplate(options) {
          ...
          return React21.createElement("ul", listProps2, content);
        }
      });
      return React21.createElement(VirtualScroller, _extends12({
    ...
    return React21.createElement("div", wrapperProps, React21.createElement("ul", listProps, items));
  };
  var createElement13 = function createElement14() {
    ...
    return React21.createElement(CSSTransition2, _extends12({
      nodeRef: ref
    }, transitionProps), React21.createElement("div", _extends12({
      ref
    }, panelProps), props.firstFocusableElement, filter2, content, footer, props.lastFocusableElement));
  };
  var element = createElement13();
  return React21.createElement(Portal, {
    element,
    appendTo: props.appendTo
  });
}));
...
var Dropdown = React21.memo(React21.forwardRef(function(inProps, ref) {
  var mergeProps2 = useMergeProps();
  var context = React21.useContext(PrimeReactContext);
  var props = DropdownBase.getProps(inProps, context);
  var _React$useState = React21.useState(""), _React$useState2 = _slicedToArray7(_React$useState, 2), filterState = _React$useState2[0], setFilterState = _React$useState2[1];
  var _React$useState3 = React21.useState(false), _React$useState4 = _slicedToArray7(_React$useState3, 2), focusedState = _React$useState4[0], setFocusedState = _React$useState4[1];
  var _React$useState5 = React21.useState(-1), _React$useState6 = _slicedToArray7(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var _React$useState7 = React21.useState(false), _React$useState8 = _slicedToArray7(_React$useState7, 2), overlayVisibleState = _React$useState8[0], setOverlayVisibleState = _React$useState8[1];
  var clickedRef = React21.useRef(false);
  var elementRef = React21.useRef(null);
  var overlayRef = React21.useRef(null);
  var firstHiddenFocusableElementOnOverlay = React21.useRef(null);
  var lastHiddenFocusableElementOnOverlay = React21.useRef(null);
  var inputRef = React21.useRef(props.inputRef);
  var focusInputRef = React21.useRef(props.focusInputRef);
        ...
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done; ) {
            ...
            if (filteredSubOptions && filteredSubOptions.length) {
              filteredGroups.push(_objectSpread7(_objectSpread7({}, optgroup), _defineProperty8({}, "".concat(props.optionGroupChildren), filteredSubOptions)));
            }
          }
        } catch (err) {
          _iterator.e(err);
  ...
  var createHiddenSelect = function createHiddenSelect2() {
    ...
    return React21.createElement("div", hiddenSelectedMessageProps, React21.createElement("select", selectProps, React21.createElement("option", optionProps, option.label)));
  };
  var createKeyboardHelper = function createKeyboardHelper2() {
    ...
    var inputProps = mergeProps2(_objectSpread7({
      ref: focusInputRef,
      id: props.inputId,
      defaultValue: value,
      type: "text",
    ...
    return React21.createElement("div", hiddenSelectedMessageProps, React21.createElement("input", inputProps));
  };
  var createLabel = function createLabel2() {
    var label = ObjectUtils.isNotEmpty(selectedOption) ? getOptionLabel(selectedOption) : null;
    if (props.editable) {
      var value = label || props.value || "";
      var _inputProps = mergeProps2(_objectSpread7({
        ref: inputRef,
        type: "text",
        defaultValue: value,
        className: cx("input", {
      ...
      return React21.createElement("input", _inputProps);
    }
    var content = props.valueTemplate ? ObjectUtils.getJSXElement(props.valueTemplate, selectedOption, props) : label || props.placeholder || props.emptyMessage || React21.createElement(React21.Fragment, null, " ");
    ...
    return React21.createElement("span", inputProps, content);
  };
  ...
  var createClearIcon = function createClearIcon2() {
    if (props.value != null && props.showClear && !props.disabled && !ObjectUtils.isEmpty(props.options)) {
      ...
      var icon = props.clearIcon || React21.createElement(TimesIcon, clearIconProps);
  ...
  var createLoadingIcon = function createLoadingIcon2() {
    ...
    var icon = props.loadingIcon || React21.createElement(SpinnerIcon, {
      spin: true
    });
    var loadingIcon = IconUtils.getJSXIcon(icon, _objectSpread7({}, loadingIconProps), {
      props
    });
    ...
    return React21.createElement("div", loadingButtonProps, loadingIcon);
  };
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    var icon = !overlayVisibleState ? props.dropdownIcon || React21.createElement(ChevronDownIcon, dropdownIconProps) : props.collapseIcon || React21.createElement(ChevronUpIcon, dropdownIconProps);
    var dropdownIcon2 = IconUtils.getJSXIcon(icon, _objectSpread7({}, dropdownIconProps), {
      props
    });
    var ariaLabel = props.placeholder || props.ariaLabel;
    ...
    return React21.createElement("div", triggerProps, dropdownIcon2);
  };
  ...
  return React21.createElement(React21.Fragment, null, React21.createElement("div", rootProps, keyboardHelper, hiddenSelect, labelElement, clearIcon, dropdownIcon, React21.createElement(DropdownPanel, _extends12({
    hostName: "Dropdown",
    ref: overlayRef,
    visibleOptions,
    virtualScrollerRef
    ...
    firstFocusableElement: React21.createElement("span", firstHiddenFocusableElementProps),
    lastFocusableElement: React21.createElement("span", lastHiddenFocusableElementProps),
    sx
  }))), hasTooltip && React21.createElement(Tooltip, _extends12({
    target: elementRef,
